...
cd $(go env GOMODCACHE)/github.com/nonibytes/ffgo@latest/shim
./build.sh
...
```go
import (
    "github.com/nonibytes/ffgo/avcodec"
    "github.com/nonibytes/ffgo/avformat"
    "github.com/nonibytes/ffgo/avutil"
)
...
Open an issue at https://github.com/nonibytes/ffgo/issues with:
