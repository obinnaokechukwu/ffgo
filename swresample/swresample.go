...
import (
	...
	"github.com/nonibytes/ffgo/internal/bindings"
)
...
var (
	...
	swr_is_initialized  func(s SwrContext) int32
	swr_close           func(s SwrContext)

	// For FFmpeg 5.1+ with AVChannelLayout
	swr_alloc_set_opts2 func(ps *SwrContext, outChLayout, inChLayout unsafe.Pointer,
		outFmt, inFmt int32, outRate, inRate int32,
		logOffset int32, logCtx unsafe.Pointer) int32

	// Legacy API for older FFmpeg
	swr_alloc_set_opts func(s SwrContext,
		outChLayout int64, outFmt, outRate int32,
		inChLayout int64, inFmt, inRate int32,
		logOffset int32, logCtx unsafe.Pointer) uintptr
)
...
func AllocSetOpts(s SwrContext, outChLayout int64, outSampleFmt, outSampleRate int32,
	...
	return unsafe.Pointer(swr_alloc_set_opts(s, outChLayout, outSampleFmt, outSampleRate,
...
func AllocSetOpts2(ps *SwrContext, outChLayout, inChLayout unsafe.Pointer,
	...
	ret := swr_alloc_set_opts2(ps, outChLayout, inChLayout, outSampleFmt, inSampleFmt,
		outSampleRate, inSampleRate, 0, nil)
	if ret < 0 {
...
func Convert(s SwrContext, out unsafe.Pointer, outCount int32,
	...
	ret := swr_convert(s, out, in, outCount, inCount)
...
func ConvertFrame(s SwrContext, output, input unsafe.Pointer) error {
	...
	ret := swr_convert_frame(s, output, input)
...
func GetOutSamples(s SwrContext, inSamples int) int {
	...
	return int(swr_get_out_samples(s, int32(inSamples)))
}
